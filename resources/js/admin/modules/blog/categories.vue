<template>
    <div class="blog_categories is-relative">
        ...
        <div class="box">
            <b-table
                ...
                <b-table-column v-slot="props" label="Número de Posts" header-class="is-size-7" cell-class="is-size-7">
                    {{ props.row.count_posts }}
                </b-table-column>
...
export default {
    ...
    data() {
        return {
            row_class: { "header-class": "is-size-7 has-text-weight-bold", "cell-class": "is-size-7" },
    ...
    methods: {
        getCategories(url = null) {
            this.loading = true
            let route = !url ? "/blog/categories/get" : url
            window.axios
                .get(route, {
                    params: this.filters
                })
        ...
        createCategory(data) {
            this.loading = true
            window.axios
                .post("/blog/categories/create", data)
                .then(() => {
        ...
        updateCategory(data) {
            this.loading = true
            window.axios
                .post("/blog/categories/update", data)
                .then(() => {
