...
//
Route::get('getAllPartidas',     [PartidaController::class, 'getAllPartidas'])->name('getAllPartidas');
Route::get('getPartidasInicial', [PartidaController::class, 'getPartidasInicial'])->name('getPartidasInicial');
Route::get('getPartidasByPadre', [PartidaController::class, 'getPartidasByPadre'])->name('getPartidasByPadre');

Route::post('testInsertPartida',     [PartidaController::class, 'testInsertPartida'])->name('testInsertPartida');
